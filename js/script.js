...
var W = 500;
var H = 500;
//store the starting positon of particle;change these values to animate
var x = 100;
var y = 100;
...
function draw(){
	...
	//loop throught the particles and change each one
	...
	ctx.fill();
	//move the particle a little left and little down
	p.x+=p.vx;
	p.y+=p.vy;	
